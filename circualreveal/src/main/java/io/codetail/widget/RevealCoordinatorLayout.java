...
/**
 * Created by Golden Phoenix on 26/11/2015.
 */


public class RevealCoordinatorLayout extends CoordinatorLayout implements  RevealAnimator{
    ...
    public RevealCoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
